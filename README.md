...
### Features
:white_check_mark: Разработанный с нуля простой UI kit с интеграцией Telegram Mini Apps API (@tma.js/sdk)<br>
...
### Оглавление
1. [Клиентская часть (TMA)](#Клиентская_часть)
...
2. [Серверная часть (бот, апи)](#Серверная_часть)
   ...
   2. [Установка и деплой](#Серверная_часть_архитектура)
...
Данная методология обеспечивает низкую связанность компонентов приложения и высокую сплоченность, что уменьшает bus фактор и делает кодовую базу приложения более структурированной и масштабируемой
...
### Полезные ресурсы
[**Документация Telegram Mini Apps**](https://docs.ton.org/develop/dapps/telegram-apps/)
[**Документация @tma-js**](https://docs.telegram-mini-apps.com/docs/introduction/about-platform)
