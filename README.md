...
:white_check_mark: Поддержка нескольких точек входа: Main Bot Button, Inline Button, Direct Link, Direct Link с startapp параметром<br>
____
## Оглавление
...
3. [Полезные советы для разработчиков Telegram Mini Apps](#полезные-советы-для-разработчиков-telegram-mini-apps)
